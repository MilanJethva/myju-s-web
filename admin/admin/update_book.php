  ...
  <div class="wrapper">
   ...
   <form method="post" class="box" enctype="multipart/form-data">
	...
	if(isset($_POST['ins']))
	{
      ...
      $n=$_POST['name'];
  		$pdf = "book/".$_FILES['p']['name'];
  		$ds=$_POST['dis'];
      $course=$_POST['course'];
  
		move_uploaded_file($_FILES['p']['tmp_name'], "book/".$_FILES['p']['name']);
		

		$q =mysqli_query($c,"update pdf set id='$id',name='$n',url='$pdf',des='$ds',course='$course' where id='$id' ");
