...
<div class="main2">
    ...
    <embed class="box" type="application/pdf" src="<?php echo 'admin/teacher/'.$row['url'] ; ?>" width="380" height="400">
...
<div class="main2">
 ...
 <div class="title">
    ...
    <div>
         <a  name="down" href="download_pdf.php?id=<?php echo $row['id']; ?>" class="btnd" >DOWLOAD</a>
        <a href="buy.php" class="btnb">BuyNow</a>
    </div>
